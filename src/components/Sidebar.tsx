...
import { LayoutDashboard, Bot, MessageCircle, LogOut, MessagesSquare, Radio, LayoutGrid } from 'lucide-react'
...
const navItems = [
  ...
  { href: '/dashboard/auto-replies', label: 'Mayra Settings', icon: Bot },
